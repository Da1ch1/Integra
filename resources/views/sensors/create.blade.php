@extends('layouts.app', ['activePage' => 'sensors', 'titlePage' => __('Crear Sensor')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('sensors.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Crear Sensor') }}</h4>
                            </div>
                            <div class="card-body ">
                                @if (session('status'))
                                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Numser') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Numser') ? ' is-invalid' : '' }}" name="Numser" id="input-Numser" type="text" placeholder="{{ __('Numser') }}" value="{{ old('Numser')}}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('lugar') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('lugar') ? ' is-invalid' : '' }}" name="lugar" id="input-lugar" type="text" placeholder="{{ __('lugar') }}" value="{{ old('lugar') }}" required />
                                            @if ($errors->has('lugar'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Modelo') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Modelo') ? ' is-invalid' : '' }}" name="Modelo" id="input-Modelo" type="text" placeholder="{{ __('Modelo') }}" value="{{ old('Modelo') }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Capacidad') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Capacidad') ? ' is-invalid' : '' }}" name="Capacidad" id="input-Capacidad" type="text" placeholder="{{ __('Capacidad') }}" value="{{ old('Capacidad') }}" required />
