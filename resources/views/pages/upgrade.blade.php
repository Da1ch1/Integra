@extends('layouts.app', ['activePage' => 'upgade', 'titlePage' => __('Actualización')])
                ...
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title"> Dashboard PRO</h4>
                            <p class="card-category">Quieres ver mas? Por favor revisa nuestra Version Premium.</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table-upgrade">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><h3 class="text-primary">Integra SA.</h3></td>
                                        <td class="text-center"></td>
                                        <td class="text-center"></td>
                                    </tr>
                                    <tr>
                                        <td>Inicio, Registro, Olvidar contraseña de paginas</td>
